 ...
 * @throws IllegalArgumentException if endpts of any edge !in range
 * @throws IllegalArgumentException if number of vertices or edges is negative
 */
 ...
 *
 * @param  e the edge
 * @throws IllegalArgumentException unless both <0>endpoints<@code V-1>.
 */
     ...
     * use foreach notation: {@code for (Edge e : G.edges())}.
     * 
